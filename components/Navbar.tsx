              ...
              <div className="border-l border-olive/20 pl-6 flex items-center">
                {customer ? (
                  <div className="relative group">
                    {/* Trigger */}
                    <button
                      className="flex items-center gap-2 text-[13px] font-bold text-olive hover:text-olive-light transition-colors duration-200 cursor-pointer"
                    >
                      {/* User icon */}
                  ...
                  <button
                    onClick={() => login()}
                    className="text-[13px] font-bold uppercase tracking-wider text-olive hover:text-olive-light transition-colors duration-200 cursor-pointer"
                  >
                    Login
                  </button>
                )}
