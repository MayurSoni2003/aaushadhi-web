...
const slides: HeroSlide[] = [
  {
    ...
    background: "from-[#F8F2E6] via-[#FBF8F2] to-[#F2E5CE]",
  },
  {
    id: 2,
    badge: "BEST SELLER",
    ...
    background: "from-[#F8F2E6] via-[#FBF8F2] to-[#ECDDBF]",
  },
  {
    id: 3,
    badge: "ORGANIC",
    ...
    background: "from-[#FAF6EE] via-[#FDFBF7] to-[#EFDDBE]",
  },
  {
    id: 4,
    badge: "LIMITED",
    ...
    background: "from-[#F8F3EA] via-[#FDFBF8] to-[#EAD9BB]",
  },
  {
    id: 5,
    badge: "NEW ARRIVAL",
    ...
    secondaryBtn: "Browse",
    background: "from-[#F7F1E6] via-[#FCFAF5] to-[#E8D6B6]",
  },
];
...
export default function Hero() {
  ...
  const textVariants = {
    ...
    visible: { opacity: 1, x: 0, filter: "blur(0px)", transition: { duration: 0.7 } },
    exit: { opacity: 0, x: 60, filter: "blur(8px)", transition: { duration: 0.4 } },
  };

  const imageVariants = {
    hidden: { opacity: 0, scale: 0.9, x: 80 },
    visible: { opacity: 1, scale: 1, x: 0, transition: { duration: 0.8 } },
    exit: { opacity: 0, scale: 0.9, x: -80, transition: { duration: 0.4 } },
  };

  return (
    <section className="relative overflow-hidden bg-[#EED9BB] py-28">
        ...
        <AnimatePresence mode="wait">
          ...
          >
            ...
            <h1 className="mt-6 text-4xl font-black leading-[1.1] text-[#30412D] lg:text-5xl font-playfair">
              {slide.title}
              <span className="mt-3 block text-[#B17A32]">{slide.highlight}</span>
            </h1>
            ...
            <div className="mt-10">
              ...
              <p className="mt-2 text-xl font-medium text-[#355A29]">{slide.offerText}</p>
            </div>
            ...
            >
              <span className="text-lg text-gray-600">Use Code</span>
